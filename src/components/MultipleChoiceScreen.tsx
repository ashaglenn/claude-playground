...
import { AnswerKey, MultipleChoiceQuestion, LegacyQuestion } from '@/lib/types'

type MCQuestion = MultipleChoiceQuestion | LegacyQuestion

interface MultipleChoiceScreenProps {
  question: MCQuestion
}

export default function MultipleChoiceScreen({ question }: MultipleChoiceScreenProps) {
